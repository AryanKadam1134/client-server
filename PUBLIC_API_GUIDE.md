...
```
https://server-ze3s.onrender.com/api/admin/api/portfolio/:username
```
...
const base = "https://server-ze3s.onrender.com/api/admin/api/portfolio";
...
const res = await fetch(
  "https://server-ze3s.onrender.com/api/admin/api/portfolio/john_doe/projects?featured=true",
);
const json = await res.json();
console.log(json.data);
```
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/details`
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/social-platforms`
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/skills`
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/categories`
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/projects`
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/experiences`
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/educations`
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/certificates`
...
### GET `https://server-ze3s.onrender.com/api/admin/api/portfolio/:username/achievements`
